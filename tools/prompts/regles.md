...
**Jean-Marc Chamot** (7ème Dan) :
- Donne cours le premier lundi de chaque mois (hors vacances scolaires)
- Quand il donne cours, il assure les deux créneaux (enfants + adultes)

**Sébastien Huet** :
- Donne cours pendant les vacances scolaires
...
### Stages
- Des stages ponctuels peuvent avoir lieu le week-end (Stage Codep78, etc.)
- Les stages sont annoncés dans le groupe WhatsApp
- Types de stages : Stage Codep78, Tous niveaux
